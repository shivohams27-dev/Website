...
export const TelegramButton = ({ url }: { url: string }) => {
  return (
        ...
        <span className={styles.text}>
          <div className={styles.bordeBack}>
            <div className={styles.icon}>
              {/* Telegram SVG */}
              <svg height="23px" width="23px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                <path d="M24 4A20 20 0 1 0 24 44A20 20 0 1 0 24 4Z" fill="none" />
